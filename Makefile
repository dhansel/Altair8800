...
OBJECTS=$(OBJ)/cpucore.o $(OBJ)/mem.o $(OBJ)/serial.o $(OBJ)/profile.o $(OBJ)/breakpoint.o $(OBJ)/numsys.o $(OBJ)/filesys.o $(OBJ)/drive.o $(OBJ)/disassembler.o $(OBJ)/prog_basic.o $(OBJ)/prog_ps2.o $(OBJ)/prog_examples.o $(OBJ)/prog_tools.o $(OBJ)/prog_games.o $(OBJ)/host_pc.o $(OBJ)/config.o $(OBJ)/timer.o $(OBJ)/prog.o $(OBJ)/printer.o $(OBJ)/hdsk.o $(OBJ)/image.o
...
$(OBJ)/drive.o: drive.cpp drive.h Arduino/Arduino.h config.h host.h host_pc.h \
 cpucore.h Altair8800.h timer.h image.h
...
$(OBJ)/host_pc.o: host_pc.cpp Arduino/Arduino.h Altair8800.h mem.h config.h \
 ...
 timer.h
$(OBJ)/image.o: image.cpp host.h config.h Arduino/Arduino.h host_pc.h image.h
...
$(OBJ)/printer.o: printer.cpp printer.h Arduino/Arduino.h config.h host.h \
 host_pc.h timer.h cpucore.h Altair8800.h
...
$(OBJ)/prog_tools.o: prog_tools.cpp Arduino/Arduino.h prog_tools.h host.h \
 config.h host_pc.h mem.h prog_basic.h breakpoint.h prog.h
